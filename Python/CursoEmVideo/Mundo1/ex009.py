...
print('{} x {:2} = {}'.format(n, 1, n*1))  #utiliza-se o :2 para alinhar todos os multiplicadores de 1 dígito com o 10 (2 dígitos)
...
print('='*12)
# ↪ uso do operador de multiplicação para replicar strings
